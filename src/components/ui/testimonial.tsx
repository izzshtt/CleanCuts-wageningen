...
export function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <div className="bg-white p-6 rounded-xl shadow-[0_12px_32px_rgba(0,0,0,0.06)] w-[85vw] sm:w-[280px] shrink-0 transition-transform duration-300 hover:-translate-y-1">
